            ...
            <div className="row justify-content-center text-center">
              <div className="col-lg-8">
                ...
                <div className="text-secondary">
                  <em>&ldquo;Insight. Innovation. Implementation.&rdquo;</em>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row justify-content-center text-center">
              <div className="col-lg-8">
                ...
                <div className="d-flex justify-content-center gap-3">
                  <Link href="/contact" className="btn btn-info btn-lg">Get In Touch</Link>
                  <Link href="/pricing" className="btn btn-outline-info btn-lg">View Pricing</Link>
                </div>
              </div>
            </div>
          </div>
